...
running command...
$ fe-cli (--version)
qm-fe-cli/2.0.1-beta.2 darwin-x64 node-v16.16.0
$ fe-cli --help [COMMAND]
USAGE
  $ fe-cli COMMAND
...
...
_See code: [src/commands/build/index.ts](https://github.com/code/fe-cli/blob/v2.0.1-beta.2/src/commands/build/index.ts)_
...
_See code: [src/commands/build/world.ts](https://github.com/code/fe-cli/blob/v2.0.1-beta.2/src/commands/build/world.ts)_
...
_See code: [src/commands/create.ts](https://github.com/code/fe-cli/blob/v2.0.1-beta.2/src/commands/create.ts)_
...
_See code: [src/commands/publish/index.ts](https://github.com/code/fe-cli/blob/v2.0.1-beta.2/src/commands/publish/index.ts)_
<!-- commandsstop -->
